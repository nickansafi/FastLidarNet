...
from f1tenth_benchmarks.zarrar.tiny_lidarnet7 import TinyLidarNet
...
def test():
    test_id = "test"
    print(test_id)
    planner = Test(test_id,1, 0,os.getcwd()[0:-len(os.getcwd().lower().split("tinylidarnet")[-1])]+'/Benchmark/f1tenth_benchmarks/zarrar/test2.tflite')
...
def tinylidar_il_mean():
    ...
    planner = TinyLidarNet(test_id,4, 1,os.getcwd()[0:-len(os.getcwd().lower().split("tinylidarnet")[-1])]+'/Benchmark/f1tenth_benchmarks/zarrar/t.tflite')
    test_mapless_all_maps(planner, test_id, number_of_laps=NUMBER_OF_LAPS)
...
def tinylidar_il():
    ...
    print(test_id)
    planner = TinyLidarNet(test_id,4, 0,os.getcwd()[0:-len(os.getcwd().lower().split("tinylidarnet")[-1])]+'/Benchmark/f1tenth_benchmarks/zarrar/test2.tflite')
    test_mapless_all_maps(planner, test_id, number_of_laps=NUMBER_OF_LAPS)
...
def tinylidar_il_m():
    ...
    print(test_id)
    planner = TinyLidarNet(test_id,2, 0,os.getcwd()[0:-len(os.getcwd().lower().split("tinylidarnet")[-1])]+'/Benchmark/f1tenth_benchmarks/zarrar/test3.tflite')
...
def tinylidar_il_l(n):
    test_id = "benchmark_tiny_il_l"
    print(test_id)
    planner = TinyLidarNet(test_id,n, 0,os.getcwd()[0:-len(os.getcwd().lower().split("tinylidarnet")[-1])]+'/Models/TLN.keras')
    # planner = TinyLidarNet(test_id,1, 0,'/home/m810z573/Downloads/f1tenth_benchmarks/f1tenth_benchmarks/zarrar/f1_tenth_model_diff_TLN_L_Dropout_noquantized.tflite')
    # planner = TinyLidarNet(test_id,1, 0,'/home/m810z573/Downloads/f1tenth_benchmarks/f1tenth_benchmarks/zarrar/f1_tenth_model_diff_TLN_L_Dag_noquantized.tflite')
    test_mapless_all_maps(planner, test_id, number_of_laps=NUMBER_OF_LAPS)
