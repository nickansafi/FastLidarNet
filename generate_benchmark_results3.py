...
from f1tenth_benchmarks.zarrar.tiny_lidarnet3 import TinyLidarNet
...
def tinylidar_il_m():
    ...
    print(test_id)
    planner = TinyLidarNet(test_id,1, 0,os.path.abspath(__file__).rpartition("/Benchmark")[0]+'/Benchmark/f1tenth_benchmarks/zarrar/TLNtest4.keras')
